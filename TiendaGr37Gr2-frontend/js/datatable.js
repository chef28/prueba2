class Datatable{
    ...
    element;/*hace referencia a toda la tabla*/
    headers;
    items;
    copyItems;/*para la busqueda*/
    selected;/*para saber que elementos se seleccionaron con el checkbox*/
    pagination;/*para calcular las paginas*/
    numberOfEntries;/*numero de entradas para mostrar por pagina*/
    headerButtons;/*Botones del encabezado, permiten acciones del crud*/
